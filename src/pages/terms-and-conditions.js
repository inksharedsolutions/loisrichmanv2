				...
				<div className="container">
					<div className="row">
						<div className={`col-lg-12`}>
							<p>
								Lois Richman offers this Web site, including all information, software, products and
								...
								the terms, conditions, policies and notices stated here. Lois Richman reserves the right
								to make changes to these Terms and Conditions immediately by posting the changed Terms
								and Conditions in this location.
							</p>
							<p>
								Your continued use of the Web site constitutes your agreement to all such terms,
								conditions and notices, and any changes to the Terms and Conditions made by Lois
								Richman.
							</p>
							<p>
							...
							<p>
								...
								warranty of any kind either express or implied. Neither Lois Richman nor its employees,
								...
								site on behalf of Lois Richman. Lois Richman reserves the right to change or discontinue
								at any time any aspect or feature of the Web site.
							</p>
							...
							<p>
								Certain areas of this Website are restricted from access by you and Lois Richman may
							...
							<p>
								None of the material contained by Lois Richman may be reverse-engineered, disassembled,
								...
								written consent of Lois Richman. Violation of this provision may result in severe civil
								and criminal penalties.
							</p>
							<p>
								Your Content must be your own and must not be infringing on any third party’s rights.{' '}
								Lois Richman reserves the right to remove any of Your Content from this Website at any
